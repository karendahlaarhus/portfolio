            ...
            <ul className="about-items">
              ...
              <li className="about-item">
                ...
                <p className="about-text">
                  Jeg er Karen og er en student på 3. året av en bachelor i
                  informatikk ved NTNU i Trondheim! Her har jeg samlet
                ...
                <p className="about-text">
                  ...
                  erfaring med diverse, blant annet HTML5, CSS,
                  Javascript/Typescript, Python, React og Django.
                </p>
              </li>
            </ul>
          </div>
